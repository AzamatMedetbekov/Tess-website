  ...
  '@font-face': [
    {
      ...
      src: `url("/static/font/Satoshi-Variable.woff2") format("woff2"),
        url("static/font/Satoshi-Variable.woff") format("woff")`,
      fontWeight: 'bold',
      fontStyle: 'normal',
    },
    {
      fontFamily: 'Fira Code',
      src: `url("static/font/AllianceNo2Light.woff") format("woff")`,
      fontWeight: 'bold',
      fontStyle: 'normal',
    },
    {
